...
async function main() {
  ...
  const OLD = "var CREDS = { user: 'tomczak24brandon@gmail.com', pass: 'Gordon24@' };";
  const NEW = "var CREDS = { user: 'tomczak24brandon@gmail.com', pass: 'Gordon2448@@@' };";

  if (html.includes(OLD)) {
    html = html.split(OLD).join(NEW);
    console.log('✅ Password updated');
  } else {
    console.log('❌ CREDS line not matched');
    process.exit(1);
  }
