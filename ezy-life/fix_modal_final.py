...
# ── Normalize stacked carriage returns (\r\r\r\n -> \n) ─────────────────────
c = re.sub(r'\r+\n', '\n', c)
c = re.sub(r'\r', '\n', c)
...
# ── 1. Replace stripped taskdetail modal body ─────────────────────────────────
OLD_BODY = (
...
patch("taskdetail modal body: full replacement", OLD_BODY, NEW_BODY)

# ── 2. Fix reassign modal title (now has plain ? not FFFD after purge) ────────
