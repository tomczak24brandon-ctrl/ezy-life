...
window.addDetailStep = addDetailStep;
window.toggleGoalStep = toggleGoalStep;
window.deleteGoalStep = deleteGoalStep;
window.renderGoalStepsList = renderGoalStepsList;
window.renderGoalsDashboard = renderGoalsDashboard;
window.renderGoalsYearOverview = renderGoalsYearOverview;
window.archToggleYear = archToggleYear;
window.openEditGoalModal = openEditGoalModal;
window.openAddGoalModal = openAddGoalModal;
window.saveGoal = saveGoal;
window.updateGoalsCount = updateGoalsCount;
window.openGoalDetail = openGoalDetail;
window.gdAddStep = gdAddStep;
window.gdDashToggleStep = gdDashToggleStep;
window.gdDashStepDateChange = gdDashStepDateChange;
window.gdToggleStep = gdToggleStep;
window.gdUpdateStepText = gdUpdateStepText;
window.gdDeleteStep = gdDeleteStep;
window.gdSave = gdSave;
window.gdDeleteGoal = gdDeleteGoal;
window.confirmReassign = confirmReassign;
window.goalsShowOverdue = goalsShowOverdue;
window.goalsLoadTabs = goalsLoadTabs;
window.goalsEditTabs = goalsEditTabs;
window.goalsEditTabsSave = goalsEditTabsSave;
window.goalsGoTab = goalsGoTab;
window.goalsCarouselInit = goalsCarouselInit;
window.checkStepOverdue = checkStepOverdue;
