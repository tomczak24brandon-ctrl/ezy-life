...
// --- window exports ---
window.setAMPM_td        = setAMPM_td;
window.setEndAMPM_td     = setEndAMPM_td;
window.autoToggleAMPM_td = autoToggleAMPM_td;
window.getTdPickedTime       = getTdPickedTime;
window.getTdPickedEndTime    = getTdPickedEndTime;
window.buildTdColorPicker    = buildTdColorPicker;
window.pickTdColor           = pickTdColor;
window.tdAddSub              = tdAddSub;
window.remTdSub              = remTdSub;
window.updateTdSub           = updateTdSub;
window.tdSave                = tdSave;
window.tdDelete              = tdDelete;
window.openAddTaskModal      = openAddTaskModal;
window.addTaskDateChanged    = addTaskDateChanged;
window.addNewSub             = addNewSub;
window.updateNewSub          = updateNewSub;
window.remNewSub             = remNewSub;
window.onReminderChange      = onReminderChange;
window.buildCustomReminder   = buildCustomReminder;
window.onRruleChange         = onRruleChange;
window.updateRruleFreqLabel  = updateRruleFreqLabel;
window.toggleRruleDay        = toggleRruleDay;
window.scheduleTaskReminder  = scheduleTaskReminder;
window.rescheduleAllReminders = rescheduleAllReminders;
window.saveTask              = saveTask;
window.renderTdSubList       = renderTdSubList;
window.renderNewSubList      = renderNewSubList;
