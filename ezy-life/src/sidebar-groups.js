...
// --- window exports ---
if (typeof sgToggleCollapse !== 'undefined') window.sgToggleCollapse = sgToggleCollapse;
if (typeof sgItemDragStart !== 'undefined') window.sgItemDragStart = sgItemDragStart;
if (typeof sgItemDragOver !== 'undefined') window.sgItemDragOver = sgItemDragOver;
if (typeof sgItemDrop !== 'undefined') window.sgItemDrop = sgItemDrop;
if (typeof sgItemDragEnd !== 'undefined') window.sgItemDragEnd = sgItemDragEnd;
if (typeof sgDragStart !== 'undefined') window.sgDragStart = sgDragStart;
if (typeof sgDragOver !== 'undefined') window.sgDragOver = sgDragOver;
if (typeof sgDrop !== 'undefined') window.sgDrop = sgDrop;
if (typeof sgDragEnd !== 'undefined') window.sgDragEnd = sgDragEnd;
if (typeof sgRename !== 'undefined') window.sgRename = sgRename;
if (typeof sgItemEdit !== 'undefined') window.sgItemEdit = sgItemEdit;
if (typeof sgitemPickEmoji !== 'undefined') window.sgitemPickEmoji = sgitemPickEmoji;
if (typeof sgitemEmojiTyped !== 'undefined') window.sgitemEmojiTyped = sgitemEmojiTyped;
if (typeof sgitemClearIcon !== 'undefined') window.sgitemClearIcon = sgitemClearIcon;
if (typeof sgItemSave !== 'undefined') window.sgItemSave = sgItemSave;
if (typeof sgAddItem !== 'undefined') window.sgAddItem = sgAddItem;
if (typeof sgFinCatToggle !== 'undefined') window.sgFinCatToggle = sgFinCatToggle;
if (typeof loadSaved !== 'undefined') window.loadSaved = loadSaved;
if (typeof saveSidebarToStorage !== 'undefined') window.saveSidebarToStorage = saveSidebarToStorage;
if (typeof loadSidebarFromStorage !== 'undefined') window.loadSidebarFromStorage = loadSidebarFromStorage;
