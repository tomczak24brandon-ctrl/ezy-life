...
// --- window exports ---
if (typeof openCatModal !== 'undefined') window.openCatModal = openCatModal;
if (typeof renameCat !== 'undefined') window.renameCat = renameCat;
if (typeof catItemDragStart !== 'undefined') window.catItemDragStart = catItemDragStart;
if (typeof catItemDragOver !== 'undefined') window.catItemDragOver = catItemDragOver;
if (typeof catItemDrop !== 'undefined') window.catItemDrop = catItemDrop;
if (typeof catItemDragEnd !== 'undefined') window.catItemDragEnd = catItemDragEnd;
if (typeof renderCatList !== 'undefined') window.renderCatList = renderCatList;
if (typeof openCatEP !== 'undefined') window.openCatEP = openCatEP;
if (typeof addCat !== 'undefined') window.addCat = addCat;
if (typeof delCat !== 'undefined') window.delCat = delCat;
if (typeof toggleEP !== 'undefined') window.toggleEP = toggleEP;
if (typeof closeAllEPs !== 'undefined') window.closeAllEPs = closeAllEPs;
if (typeof buildTaskColorPicker !== 'undefined') window.buildTaskColorPicker = buildTaskColorPicker;
if (typeof selectTaskColor !== 'undefined') window.selectTaskColor = selectTaskColor;
if (typeof mcatToggleEP !== 'undefined') window.mcatToggleEP = mcatToggleEP;
if (typeof mcatUploadIcon !== 'undefined') window.mcatUploadIcon = mcatUploadIcon;
if (typeof mcatHandleUpload !== 'undefined') window.mcatHandleUpload = mcatHandleUpload;
if (typeof mcatNewUpload !== 'undefined') window.mcatNewUpload = mcatNewUpload;
if (typeof mcatSave !== 'undefined') window.mcatSave = mcatSave;
if (typeof mcatDelete !== 'undefined') window.mcatDelete = mcatDelete;
if (typeof mcatAdd !== 'undefined') window.mcatAdd = mcatAdd;
if (typeof onGCatChange !== 'undefined') window.onGCatChange = onGCatChange;
if (typeof addCustomCategory !== 'undefined') window.addCustomCategory = addCustomCategory;
if (typeof openManageCatsModal !== 'undefined') window.openManageCatsModal = openManageCatsModal;
if (typeof renderMcatList !== 'undefined') window.renderMcatList = renderMcatList;
if (typeof _epSetCat !== 'undefined') window._epSetCat = _epSetCat;
if (typeof _epSearch !== 'undefined') window._epSearch = _epSearch;
if (typeof _renderEP !== 'undefined') window._renderEP = _renderEP;
